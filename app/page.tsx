    ...
    <div className="min-h-screen bg-[#FFF8F2]">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-2xl">
          <div className="bg-black bg-opacity-50 p-8 rounded-lg backdrop-blur-sm">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 font-serif">
              Welcome to Big Heart Foundation
            </h1>
            <p className="text-lg md:text-xl mb-8 opacity-90">
              A loving home where every child matters.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/projects">
                <Button
                  variant="outline"
                  className="border-white text-[#E4703C] hover:bg-white hover:text-[#8B4513] py-3 px-6 rounded-lg text-lg"
                >
                  See Our Projects
                </Button>
              </Link>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
            <p className="text-lg text-[#654321] leading-relaxed mb-6 font-serif italic">
              "We started with just one room and a dream to give children a
              place where they could feel safe, loved, and hopeful about their
              future."
            </p>
          ...
          <Link href="/about">
            <Button
              variant="outline"
              className="border-[#E4703C] text-[#E4703C] hover:bg-[#E4703C] hover:text-white"
            >
              Read Our Full Story
            </Button>
          </Link>
      ...
      <section className="py-16 px-4 bg-[#FDF2E9]">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-[#8B4513] mb-12 text-center font-serif">
            Life Here
          </h2>
